...
<h3 align="center">🌟 精选项目</h2>

| 项目 | 技术栈 | 项目简介 |
|---------|------------|-------------|
| [基于 YOLO 的鱼类跟踪](https://github.com/Oblivionis028/ocellaris-fish-tracking-yolo-bytetrack) | Python + YOLO + Ultralytics + ByteTrack + OpenCV | 一个面向实验视频中鱼类检测、倒影识别和多目标跟踪的计算机视觉项目，包含数据集构建、CVAT 标注、YOLO 模型训练与验证以及跟踪结果分析。 |
| [共线性与 Ka/Ks 分析流程](https://github.com/Oblivionis028/bioinfo-collinearity-kaks-pipeline) | Python + Bash + DIAMOND + MCScanX + TBtools + gffread | 一个用于种内与种间共线性分析及 Ka/Ks 估算的可复用生物信息学工作流模板，包含 MCScanX 输入准备、蛋白质全对全比对、目标基因共线性筛选、CDS 提取和 Ka/Ks 结果解释，同时出于隐私考虑不包含真实基因组数据。 |
| [文献证据综合](https://github.com/Oblivionis028/literature-evidence-synthesis-skill) | Python + Codex Skill + PDF + 证据矩阵 | 一个不限定学科、采用页码级原文复核的文献阅读工作流，可将混合 PDF 文献库转换成可追溯的证据矩阵、与研究设计相匹配的质量评价和跨论文综合报告。 |

## 
<!-- GitHub 贡献图 -->
<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=Oblivionis028&theme=react-dark&hide_border=true" alt="GitHub 贡献图" style="width: 100%;"/>
</div>

<h3 align="center">📅 等距提交日历</h2>
